...
namespace conwertercsv
{
    public partial class CsvToHtmlConverterForm : Form
    {
        ...
        {
            this.inputTextBox = new TextBox { Dock = DockStyle.Top, PlaceholderText = "Ścieżka do pliku CSV..." };
            this.outputTextBox = new TextBox { Dock = DockStyle.Top, PlaceholderText = "Ścieżka do pliku HTML..." };
        ...
        private void ConvertCsvToHtml(string inputPath, string outputPath)
        {
            ...
            MessageBox.Show("Konwersja zakończona sukcesem!", "Informacja", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
}
